function dijkstra(net::Network, s::Int64, t::Int64)
    #=
        This function is used to find the route from the source to the destination, without having 
        any constrains like home node and rank nodes.
        
        Inputs -> The network struct, source node and the target node ids.
        Outputs -> The route struct for the particular trip. 
...
function dijkstra_taxi_to_nearest_charger(net::Network, s::Int64, t::Vector{Int64})::Tuple{Int64,Route}
    #=
        This function is used to find the nearest rank node from a target node. 
        
        Inputs -> network structure, target node, list of all node ids containing a rank with EV 
                   charger.
