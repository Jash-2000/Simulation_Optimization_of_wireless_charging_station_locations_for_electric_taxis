...
"""
    Finds nearest node in network to each taxi rank.

    NOTES
    -----
    -Assumes that there is a node in the network that corresponds to where each taxi rank is.
"""
#cd("/Users/jadexiao/Desktop/evrouting/wireless_charging")

jldopen("data/network-karlsruhe.jld2", "r") do fn
